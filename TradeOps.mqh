...
/*
   Generic Trade Operations Class. 
   
   Recommended to use as base class for trading logic. 
   
   Implementation is incomplete as of 4/21/2024
*/

#include <utilities/Utilities.mqh>
#include <utilities/Console.mqh> 
#include <utilities/Pool.mqh> 
